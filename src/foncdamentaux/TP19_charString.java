package foncdamentaux;//Écrire un programme Java demande à l’utilisateur de saisir un texte et qui ensuite, renseigne si celui est un palindrome(mot qui se lit de la même dans les 2 sens).
//        Ex :
//        Entrez un test : non
